...
[vote]: http://www.ludumdare.com/compo/ludum-dare-29/?action=preview&uid=18803
...
This postmortem will explain what [goes right][right] and what [goes wrong][wrong]
for this compo.
...
<a name=wrong /> What goes wrong
---

### Achievability 
**My [initial plan](https://github.com/gre/ld29/blob/master/TODO.md) was too ambitious.**
It seems to always happen with me: I get the first day a lot of ideas and motivation, and I tend to underestimate the work to be done. Then at the end of the first day, I'm frustrating to find out I won't have enough time to do all my plans.
...
I underestimate a bit the amount of work needed to find the good parameters of the simulation.
...
Time will tell us if I can accomplish that wish!
